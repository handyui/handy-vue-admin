...
import { schemaFormCheckbox, schemaFormInputNumber, schemaFormInput, schemaFormRadio, schemaFormSelect, schemaFormSwitch, schemaFormTextarea, schemaFormTreeSelect } from './components'
import {FormItem} from "./types/schema"

export default defineComponent({
  name: "dynamic-form",
  components: {
    schemaFormCheckbox, schemaFormInputNumber, schemaFormInput, schemaFormRadio, schemaFormSelect, schemaFormSwitch, schemaFormTextarea ,
    schemaFormTreeSelect,
    [Spin.name]: Spin,
    [Form.name]: Form,
  ...
  setup(props, ctx) {
    ...
    const preset = ['input', 'textarea', 'select', 'radio', 'checkbox', 'input-number', 'input-range', 'switch', 'tree-select']
